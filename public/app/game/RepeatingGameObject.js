(function (cxbird) {
    /**
        ...
        @class
    */
    cxbird.RepeatingGameObject = function RepeatingGameObject(image, x, y, z, width, height, scrollFactor) {
        this.image = image;
        this.x = x;
        this.y = 0;
        this.z = z;
    ...
    cxbird.RepeatingGameObject.prototype = new cxbird.VisualGameObject();
}(window.cxbird));